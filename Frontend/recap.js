...
function recapCommande(data) {
    ...
    if (nbrOfArticles == 1) {
        ...
        <br> Nous avons le plaisir de vous confirmer que votre commande de ${JSON.parse(localStorage.product).length} article(s) portant le numéro ${random(500000,1)} vous sera livré dans les plus brefs délais.
